    ...
    <div class="sidebar-header">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                class="sidebar-item has-sub @yield('cbmsActive')">
                <a href="#" class='sidebar-link'>
                    <i class="bi bi-hexagon-fill"></i>
                    <span>Form Elements</span>
                </a>
                <ul class="submenu @yield('subCbmsActive')">
                    <li class="submenu-item @yield('createCbmsActive')">
                        <a href="{{ url('admin/create-cbms') }}">Create CBMS</a>
                    </li>
                    <li class="submenu-item @yield('listCbmsActive')">
                        <a href="{{ url('admin/list-cbms') }}">List of CBMS</a>
                    </li>
                </ul>
            </li>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="dropdown">
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            <h6 class="mb-0 text-gray-600">{{ strtoupper(Auth::user()->name) }}</h6>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                                    <li>
                                        <h6 class="dropdown-header">Hello, {{ strtoupper(Auth::user()->name) }}</h6>
                                    </li>
